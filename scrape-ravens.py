...
domain = "baltimoreravens.com"
full_url = "https://www.baltimoreravens.com/"
    ...
    while queue:
        ...
        with open('text/'+local_domain+'/'+url[8:].replace("/", "_") + ".txt", "w") as f:
            ...
            if re.search("/team/stats/", url):
                title = "team stats"
                description = soup.find(class_="nfl-o-club").get_text()
                body = soup.find(class_="nfl-o-team-h2h-stats__list").get_text()
